...
// SQL statements (split into individual statements)
...
console.log('📝 Statements to execute:', SQL_STATEMENTS.length, '\n');

// We need to use wrangler or dashboard for this
// Let's provide instructions instead
console.log('⚠️  Due to encoding issues, please initialize the database through Cloudflare Dashboard:\n');
console.log('📋 Instructions:');
console.log('1. Go to: https://dash.cloudflare.com/' + ACCOUNT_ID + '/workers/d1');
console.log('2. Click on "lottery-materials-db"');
console.log('3. Click "Console" tab');
console.log('4. Copy and paste the SQL from: database/schema-init.sql');
console.log('5. Click "Execute"\n');

console.log('✅ Or, I will create a simpler initialization method...\n');
